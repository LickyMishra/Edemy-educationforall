...
function Coursedetails() {
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-900/50'></div>
      <div className='max-w-xl z-10 text-gray-800'>
         ...
         <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0,200)}}></p>
          {/*courseData.courseDescription.slice(0,200) helps in hidding the html tags and displays only 200 text*/}
      ...
      <p className='text-sm'>Course by <span className='text-blue-800 underline'>CodeWithJemmy</span></p>   
                  ...
                  <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-800 border-t border-gray-300'>
                    {chapter.chapterContent.map((lecture,i)=>(
                      <li key={i} className='flex items-start gap-2 py-1'>
                        <img src={assets.play_icon} alt="icon" className='w-4 h-4 mt-1' />
             ...
             <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
              ...
              <div className='pt-6'> 
                ...
                <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                  <li>Lifetime access with fee updates.</li>
                  <li>Step by step hands-on project guidelines.</li>
